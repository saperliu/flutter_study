 ...
 * @Description  页面顶部渐变色的appbar
 */

const double _kLeadingWidth = kToolbarHeight; // So the leading button is square.

class GlobalGradientAppBar extends StatefulWidget implements PreferredSizeWidget {
  GlobalGradientAppBar({
    Key key,
    this.leading,
  ...
  @override
  _GlobalGradientAppBarState createState() => _GlobalGradientAppBarState();
}

class _GlobalGradientAppBarState extends State<GlobalGradientAppBar> {
